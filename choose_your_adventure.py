...
if answer == "left":
    answer = input("You come to a river, you can walk around it or swim accross. Type walk to walk around andswim to swim across: ")
    if answer == "swim":
    ...
    if answer == "back":
        ...
        if answer == "yes":
            ...
            print("Not a valid option. you lose1")
